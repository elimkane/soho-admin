  ...
  implements OnInit
{
  ...
  selection = new SelectionModel<AccountKycListModel>(true, []);
  id?: number;
  ...
  editCall(row: AccountKycListModel) {
    this.id = row.id;
    let tempDirection: Direction;
    if (localStorage.getItem('isRtl') === 'true') {
      tempDirection = 'rtl';
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<AccountKycListModel>(true, []);
    });
    this.showNotification(
      'snackbar-danger',
...
export class ExampleDataSource extends DataSource<AccountKycListModel> {
  ...
  filteredData: Array<AccountKycListModel> = [];
  renderedData: Array<AccountKycListModel> = [];
  constructor(
  ...
  connect(): Observable<AccountKycListModel[]> {
    ...
    return merge(...displayDataChanges).pipe(
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          .slice()
          .filter((advanceTable: AccountKycListModel) => {
            const searchStr = (
  ...
  sortData(data: AccountKycListModel[]): AccountKycListModel[] {
